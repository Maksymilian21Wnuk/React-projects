...
export const navbar_str : string[] = ["Home", "About", "Services", "Team", "Blog", "Contact"];

export const name: types.Name =  {name : "Acme Corporation"};
export const slogan: types.Slogan = {slogan : "Innovation at its best"};
export const header_props : types.HeaderProps = {name, slogan};
export const about : types.About = {about : "We are a leading provider of innovative solutions in various industries. Our team is dedicated to delivering high-quality products and services to our clients worldwide."};

export const services: types.ServiceProps = {
  services: [
      {
          id: 1,
...
export const blog_posts : types.BlogPost[] = [
    {
      id: 1,
